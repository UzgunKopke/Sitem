...
const Home = () => {
  ...
  const projects = [
    ...
    { name: "ᴋᴏᴘᴋᴇɴᴡ ᴛᴏᴘʟᴜʟᴜᴋ sᴜɴᴜᴄᴜsᴜ", description: "Yazılım, teknoloji ve dijital içerik üretimi üzerine öğrenme ve işbirliği fırsatları sunan dostça bir topluluk. Katılın, birlikte büyüyelim! (22.09.2024)", url: "https://discord.gg/aJ3mbBtXVS", language: "react", extraLanguage: "typescript" },
  ...
  return (
    <div>
      <Helmet>
        <title>Kopke - Anasayfa</title>
        <meta name="description"
          content="Web tabanlı uygulamalar geliştiriyor ve Discord botları ile ilgileniyorum. Portföyüm ve becerilerim için URL Kopke adresini ziyaret edin." />
      ...
      <div className='flex justify-center py-48 text-center'>
        <div>
          <h1 className='font-bold text-4xl sm:text-6xl'>Merhaba Ben <span className='text-sky-500 underline'>Kopke</span></h1>
          <p className='text-gray-400 text-lg sm:text-xl mt-2 p-1'>Küçük Bir Girişimciyim Üsküp´de Yaşıyorum<br />15 Yaşındayım.</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className='gap-4 p-4 sm:py-8 sm:px-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-4'>
          ...
          ) : (<span>Github'da Şuanlık Bir Projem Yok. Yakında Gelicektir.</span>)}
        </div>
      </div>
