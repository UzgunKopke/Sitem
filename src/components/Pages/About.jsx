            ...
            <div className='mt-20'>
                ...
                <div className='py-0 px-0 sm:py-8 sm:px-20'>
                    <div className='flex gap-2 py-8 px-20'>
                        ...
                        <span className='font-bold text-2xl text-gray-300 sm:mt-2'>Kopke kimdir?</span>
                    </div>
                    <div className='p-4 sm:p-1'>
                        <h2 className='text-lg text-gray-300 font-medium'>Merhaba, ben Kopke!</h2>
